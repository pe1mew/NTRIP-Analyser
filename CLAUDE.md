...
| `test/` | Nine tests: RINEX loader, hostile RTCM frames, MSM C/N0 layout, legacy observations, ephemeris validity, stream capture, station report, stream clock, snapshot serialisation |
<!-- verify: test "$(ctest --test-dir build -N 2>/dev/null | grep -c 'Test #')" = 9 -->
